...
ffmpeg -hide_banner -loglevel error -y   -ss 3 -i "$tmp" -t 12   -vf "scale=-2:540:flags=lanczos,fps=24"   -an   -c:v libx264 -profile:v high -pix_fmt yuv420p   -preset slow -crf 30 -movflags +faststart   public/videos/paris-spike/paris-hero.mp4
