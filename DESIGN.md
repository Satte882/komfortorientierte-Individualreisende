...
- Für Cinematic Heroes gilt site-weit derselbe Medienrahmen: Desktop/Tablet maximal `1120px` breit bei `7:3` (≈21:9); Mobile nutzt den zentralen Breakpoint `--cinematic-hero-mobile-height`.
...
- Hero-Medien werden so ausgewählt und gecroppt, dass sie in diesem Frame funktionieren. Für Desktop wird das finale Hero-Derivat im Zielverhältnis `7:3` erzeugt und **vor Einbau visuell abgenommen**. Der Browser soll keinen unerwarteten Vertikal-Crop mehr erzeugen. Hochformat darf nicht durch aggressiven Crop den Motivkontext verlieren.
